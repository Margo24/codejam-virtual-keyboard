...
//codes, generated by pressed keys of physical keyboard
const keyCode = [
...
const Keyboard = {
    ...
    changeLanguage() {
        //clear keyContainer from old values
...
//draw keyboard in DOM
window.addEventListener("DOMContentLoaded", function () {
    Keyboard.init();
});

//connect physical keyboard keys to virtual keys
let pressed = [];
